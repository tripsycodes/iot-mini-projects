...
// NOTE: removed Arduino.h dependency
// #include "Arduino.h"
#include <stddef.h>
#include <stdint.h>
...
class ModbusMaster {
  ...
  private:
    // TODO: find out how to replace the Stream Object
    ...
    void (*_idle)();
    // preTransmission callback function; gets called before writing a Modbus
    // message
    void (*_preTransmission)();
    // postTransmission callback function; gets called after a Modbus message
    // has been sent
