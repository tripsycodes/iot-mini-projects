...
// TODO: write the bitwrite replacement
...
// BUG: potential
// NOTE: may need to reverse the argument 0, data
void ModbusMaster::send(uint8_t data) { send(word(0, data)); }
...
// TODO: write the replacement for highByte and lowByte
